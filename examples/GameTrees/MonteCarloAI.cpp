...
int MonteCarloAI::makeDecision(const GameTree::Game& game) {
...
float MonteCarloAI::expand(const GameTree::Game& game, int action) {
...
GameTree::ePlayState MonteCarloAI::simulate(GameTree::Game* game) {
